//List of Games and References to be used in the site
console.log('loaded');
var gamesList = [
  {
    "thumb": "luna64.png",
    "background": "luna.png",
    "name": "Super Galaxy Guardian Luna",
    "version": "1.0.0",
    "description": "A retro themed, third person shooter adventure taking place across several worlds. You play as Luna a new Guardian Recruit just out of the Academy. You travel across the galaxy in her personal ship liberating worlds from the massive Xhomic Empire. Meeting new species and allies along the way. Get nostalgic feelings as you feel like you are playing a 3D game from the 90's",
    "media": [
      "https://img.itch.zone/aW1hZ2UvMTQ4MTY3LzgzODcyMi5qcGc=/original/W5O790.jpg",
      "https://img.itch.zone/aW1hZ2UvMTQ4MTY3LzgzODcyNC5qcGc=/original/yU35qC.jpg",
      "https://www.youtube.com/watch?v=Ob_P8xQhwlo"
    ],
    "download": "https://gamejolt.com/games/luna64/259614"
  },
  {
    "thumb": "terrathumb.png",
    "background": "terra.png",
  ...
  {
    "thumb": "annexthumb.png",
    "background": "annex.png",
    ...
    "download": "https://gamejolt.com/games/annex-conquer-the-world/35645",
    "gitHub": "https://bitbucket.org/annexctw"
  },
  {
    "thumb": "commandassaultthumb.png",
    "background": "command_assault_jets.png",
    ...
    "requires": "Megaglest",
    "news": "News: Command Assault is now available via Megaglest's built in mod menu!"
  },
  {
    "thumb": "chasmthumb.png",
    "background": "chasm_alandia_infantry.png",
    "name": "CHASM",
    "version": "unreleased",
